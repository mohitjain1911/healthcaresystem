	...
	<div class="wthree_agile_admin_info">
		...
		<div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
				...
				<!-- //nav_agile_w3l -->
				<li style="float:left" class="second logo admin">
					<h1><a href=""><i class="fa fa-graduation-cap" aria-hidden="true"></i>Health Care System </a></h1>
				</li>
		...
		<div class="copyrights">
			<p>© 2021 Health Care System. All Rights Reserved </p>
		</div>
